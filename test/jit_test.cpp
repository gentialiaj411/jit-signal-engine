...
int main() {
  ...
  jitse::PrewarmSignalContext(ctx, def);
  ...
  jitse::PrewarmSignalContext(jit_nan_ctx, nan_def);
  ...
  jitse::PrewarmSignalContext(z_jit_ctx, z_def);
  ...
  jitse::PrewarmSignalContext(v_jit_ctx, v_def);
  ...
  jitse::PrewarmSignalContext(lag_jit_ctx, lag_def);
  ...
  double rmin5 = rmin_fn(&market, &rmin_jit_ctx);
  ...
  jitse::PrewarmSignalContext(cross_jit_ctx, cross_def);
  ...
  jitse::PrewarmSignalContext(cb_jit_ctx, cross_below_def);
  ...
  for (std::size_t i = 0; i < prog_signals.size(); ++i) {
    ...
    jitse::PrewarmSignalContext(program_ctx, prog_signals[i]);
  }
