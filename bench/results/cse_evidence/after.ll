...
entry:
  ...
  %ema5 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid, double 0x3FA0C9714FBCDA3B, i64 60)
  %out_ptr6 = getelementptr double, ptr %outputs, i64 1
  store double %ema5, ptr %out_ptr6, align 8
  %rstd = tail call double @jit_rt_rolling_std(ptr %ctx, i64 1, double %mid, i64 30)
  %out_ptr9 = getelementptr double, ptr %outputs, i64 2
  store double %rstd, ptr %out_ptr9, align 8
  %ema12 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid, double 0x3FC745D1745D1746, i64 10)
  %ema15 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 2, double %mid, double 0x3FA0C9714FBCDA3B, i64 60)
  %sub = fsub double %ema12, %ema15
  %out_ptr16 = getelementptr double, ptr %outputs, i64 3
  store double %sub, ptr %out_ptr16, align 8
  %ema19 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid, double 0x3FC745D1745D1746, i64 10)
  %ema22 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 2, double %mid, double 0x3FA0C9714FBCDA3B, i64 60)
  %gt = fcmp ogt double %ema19, %ema22
  %rstd25 = tail call double @jit_rt_rolling_std(ptr %ctx, i64 3, double %mid, i64 30)
  %gt26 = fcmp ogt double %rstd25, 0.000000e+00
  %and = and i1 %gt, %gt26
  br i1 %and, label %then, label %ifcont

then:                                             ; preds = %entry
  %ema30 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 4, double %mid, double 0x3FC745D1745D1746, i64 10)
  %ema33 = tail call double @jit_rt_ema_alpha(ptr %ctx, i64 5, double %mid, double 0x3FA0C9714FBCDA3B, i64 60)
  %sub34 = fsub double %ema30, %ema33
  %rstd37 = tail call double @jit_rt_rolling_std(ptr %ctx, i64 6, double %mid, i64 30)
