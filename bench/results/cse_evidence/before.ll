...
entry:
  ...
  %mid_sum3 = fadd double %mid_bid, %mid_ask
  %mid4 = fmul double %mid_sum3, 5.000000e-01
  %ema5 = call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid4, double 0x3FA0C9714FBCDA3B, i64 60)
  %out_ptr6 = getelementptr double, ptr %outputs, i64 1
  store double %ema5, ptr %out_ptr6, align 8
  %mid_sum7 = fadd double %mid_bid, %mid_ask
  %mid8 = fmul double %mid_sum7, 5.000000e-01
  %rstd = call double @jit_rt_rolling_std(ptr %ctx, i64 1, double %mid8, i64 30)
  %out_ptr9 = getelementptr double, ptr %outputs, i64 2
  store double %rstd, ptr %out_ptr9, align 8
  %mid_sum10 = fadd double %mid_bid, %mid_ask
  %mid11 = fmul double %mid_sum10, 5.000000e-01
  %ema12 = call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid11, double 0x3FC745D1745D1746, i64 10)
  %mid_sum13 = fadd double %mid_bid, %mid_ask
  %mid14 = fmul double %mid_sum13, 5.000000e-01
  %ema15 = call double @jit_rt_ema_alpha(ptr %ctx, i64 2, double %mid14, double 0x3FA0C9714FBCDA3B, i64 60)
  %sub = fsub double %ema12, %ema15
  %out_ptr16 = getelementptr double, ptr %outputs, i64 3
  store double %sub, ptr %out_ptr16, align 8
  %mid_sum17 = fadd double %mid_bid, %mid_ask
  %mid18 = fmul double %mid_sum17, 5.000000e-01
  %ema19 = call double @jit_rt_ema_alpha(ptr %ctx, i64 1, double %mid18, double 0x3FC745D1745D1746, i64 10)
  %mid_sum20 = fadd double %mid_bid, %mid_ask
  %mid21 = fmul double %mid_sum20, 5.000000e-01
  %ema22 = call double @jit_rt_ema_alpha(ptr %ctx, i64 2, double %mid21, double 0x3FA0C9714FBCDA3B, i64 60)
  %gt = fcmp ogt double %ema19, %ema22
  %gt_f = uitofp i1 %gt to double
  %mid_sum23 = fadd double %mid_bid, %mid_ask
  %mid24 = fmul double %mid_sum23, 5.000000e-01
  %rstd25 = call double @jit_rt_rolling_std(ptr %ctx, i64 3, double %mid24, i64 30)
...
then:                                             ; preds = %entry
  %mid_sum28 = fadd double %mid_bid, %mid_ask
  %mid29 = fmul double %mid_sum28, 5.000000e-01
  %ema30 = call double @jit_rt_ema_alpha(ptr %ctx, i64 4, double %mid29, double 0x3FC745D1745D1746, i64 10)
  %mid_sum31 = fadd double %mid_bid, %mid_ask
  %mid32 = fmul double %mid_sum31, 5.000000e-01
  %ema33 = call double @jit_rt_ema_alpha(ptr %ctx, i64 5, double %mid32, double 0x3FA0C9714FBCDA3B, i64 60)
  %sub34 = fsub double %ema30, %ema33
  %mid_sum35 = fadd double %mid_bid, %mid_ask
  %mid36 = fmul double %mid_sum35, 5.000000e-01
  %rstd37 = call double @jit_rt_rolling_std(ptr %ctx, i64 6, double %mid36, i64 30)
